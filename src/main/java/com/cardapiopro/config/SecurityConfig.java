...
import com.cardapiopro.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/coupons/**").hasAnyRole("ADMIN", "SUPER_ADMIN")

                        // Kitchen
                        .requestMatchers("/api/v1/orders/*/prepare").hasAnyRole("KITCHEN", "ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/api/v1/orders/*/ready").hasAnyRole("KITCHEN", "ADMIN", "SUPER_ADMIN")
